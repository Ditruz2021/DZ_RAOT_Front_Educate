...
export interface UserThemeConfig {
  app: {
    ...
    enableNavbarSearch: boolean
    enableNavbarI18n: boolean
    enableNavbarShortcuts: boolean
    theme: string
...
export interface ThemeConfig {
  app: {
    ...
    enableNavbarSearch: UserThemeConfig['app']['enableNavbarSearch']
    enableNavbarI18n: UserThemeConfig['app']['enableNavbarI18n']
    enableNavbarShortcuts: UserThemeConfig['app']['enableNavbarShortcuts']
