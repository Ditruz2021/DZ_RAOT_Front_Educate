  ...
  return {
    themeConfig: {
      app: {
        ...
        enableNavbarSearch: userConfig.app.enableNavbarSearch,
        enableNavbarI18n: userConfig.app.enableNavbarI18n,
        enableNavbarShortcuts: userConfig.app.enableNavbarShortcuts,
